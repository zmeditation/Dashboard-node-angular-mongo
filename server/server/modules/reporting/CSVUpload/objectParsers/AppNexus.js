...
function createReportObject(bodyObject) {
    ...
    return {
        property: {
            ...
            property_id: getPropertyID(bodyObject['placement']),
            refs_to_user: null,
            am: null
        },
        ...
        matched_request: convertToInteger(bodyObject['imps'], 10),
        day: parseDate(bodyObject['day']),
        ecpm: parseECPM(bodyObject['rpm']),
        report_origin: 'AppNexus'
    };
    ...
    function getPropertyID(placement) {
