...
export default class GetVersionInformationRequest implements MiddlewareContract {
  private fields = {
    version: 'version',
    userRole: 'userRole'
  };
  ...
  public use(request: Request, response: Response, next: Function) {
    try {
      ...
      if (!Validator.hasValueInArray(userRole, ROLES)) {
        errors.push(this.fields.userRole);
      }
