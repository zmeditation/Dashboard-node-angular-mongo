...
import HandleAnalyticsFiles from '../../server/services/analytics/handleAnalyticsFiles';

import { GetForLastThirtyDays } from '../../server/services/analytics/ManagersAnalytics/ForLastThirtyDays/GetForLastThirtyDays';
import { UpdateForLastThirtyDays } from '../../server/services/analytics/ManagersAnalytics/ForLastThirtyDays/UpdateForLastThirtyDays';
...
describe('Check ManagersAnalytics', () => {
...
const checkAnalyticsObject = (analyticsObj) => {
	...
	if (analytics.length) {
		...
		analytics.forEach(obj => {
			...
			const { _id, name, analytics: analyticsRevenue } = obj;
